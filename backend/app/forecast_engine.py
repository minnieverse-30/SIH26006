...
def generate_forecast(route):
    """
    Generate freight forecast for a route.
    """
    ...
    lower, upper = calculate_forecast_range(
        forecast,
        volatility
    )
    ...
    return {
        ...
        "note": (
            "Forecast confidence is limited by "
            "the small historical dataset. "
            "More historical observations are "
